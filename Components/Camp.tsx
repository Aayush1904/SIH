        ...
        <div className={`h-full w-full min-w-[1100px] ${backgroundImage} bg-cover bg-no-repeat lg:rounded-r-5xl 2xl:rounded-5xl`}>
            <div className="flex h-full flex-col items-start justify-between p-6 lg:px-20 lg:py-10">
                ...
                <div className="flex items-center justify-center gap-6">
                    ...
                    <p className="text-[16px] font-[700] md:text-[20px] font-[700] text-white">{peopleJoined}</p>
                </div>
            </div>
        </div>
    )
            ...
            <div className="flex items-center justify-end mt-10 px-6 lg:-mt-60 lg:mr-6">
                <div className="bg-green-50 p-8 lg:max-w-[500px] xl:max-w-[734px] xl:rounded-5xl xl:px-16 xl:py-20 relative w-full overflow-hidden rounded-3xl">
                    <h2 className="text-[24px] font-[400] md:text-[32px] font-[400] 2xl:text-[64px] font-[400] leading-[120%] capitalize text-white">
                        <strong>Wanna Grow up?</strong> Check out here.
                    </h2>
                    <p className="text-[14px] font-[400] xl:text-[16px] font-[400] mt-5 text-white">
                        Predict and grow your crops and sell them to the best prices with 90% Accuracy promise from our team .. Striongly recomended to use this model and satisfy yourself!
                    </p>
                    <Image
                        src="/quote.svg"
                        alt="camp-2"
